...
public class FallbackKoraAspect implements KoraAspect {
    ...
    public ApplyResult apply(ExecutableElement method, String superCall, AspectContext aspectContext) {
        ...
        var managerType = env.getTypeUtils().getDeclaredType(env.getElementUtils().getTypeElement("io.koraframework.resilient.fallback.FallbackManager"));
        var fieldManager = aspectContext.fieldFactory().constructorParam(managerType, List.of());
        var fallbackType = env.getTypeUtils().getDeclaredType(env.getElementUtils().getTypeElement("io.koraframework.resilient.fallback.Fallback"));
