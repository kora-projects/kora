...
public class ValidationJsonValueArgumentMonoTests extends AbstractValidationAnnotationProcessorTest implements ValidatorModule {
        ...
        var compileResult = compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public Mono<Void> test(JsonValue<String> arg) {
                        return Mono.empty();
                    }
                }
                """);
    ...
    public void argumentJsonNullableNonNullIsUndefined() {
        var compileResult = compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public Mono<Void> test(@Nonnull JsonValue<String> arg) {
                        return Mono.empty();
                    }
                }
                """);
    ...
    public void argumentJsonNullableWithValidatorIsUndefined() {
        var compileResult = compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public Mono<Void> test(@NotBlank @NotEmpty JsonValue<String> arg) {
                        return Mono.empty();
                    }
                }
                """);
