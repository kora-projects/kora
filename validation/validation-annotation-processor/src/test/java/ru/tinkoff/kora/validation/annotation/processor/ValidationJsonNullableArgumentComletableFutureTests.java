        ...
        compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public CompletableFuture<Void> test(JsonNullable<String> value) {
    ...
    public void argumentJsonNullableNonNullIsUndefined() {
        compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public CompletableFuture<Void> test(@Nonnull JsonNullable<String> value) {
                        return CompletableFuture.completedFuture(null);
                    }
                }
                """);
    ...
    public void argumentJsonNullableWithValidatorIsUndefined() {
        compile(List.of(new KoraAppProcessor(), new ValidAnnotationProcessor(), new AopAnnotationProcessor()),
            """
                ...
                public class TestComponent {
                    @Validate
                    public CompletableFuture<Void> test(@NotBlank @NotEmpty JsonNullable<String> value) {
                        return CompletableFuture.completedFuture(null);
                    }
                }
                """);
