...
public interface SoapClasses {
    default TypeName httpClientTypeName() {
        return ClassName.get("io.koraframework.http.client.common", "HttpClient");
    }

    default TypeName soapEnvelopeObjectFactory() {
        return ClassName.get("io.koraframework.soap.client.common.envelope", "ObjectFactory");
    }

    default TypeName soapEnvelopeTypeName() {
        return ClassName.get("io.koraframework.soap.client.common.envelope", "SoapEnvelope");
    }

    default TypeName soapClientTelemetryFactory() {
        return ClassName.get("io.koraframework.soap.client.common.telemetry", "SoapClientTelemetryFactory");
    }

    default TypeName soapServiceConfig() {
        return ClassName.get("io.koraframework.soap.client.common", "SoapServiceConfig");
    }

    default TypeName soapRequestExecutor() {
        return ClassName.get("io.koraframework.soap.client.common", "SoapRequestExecutor");
    }

    default TypeName soapResult() {
        return ClassName.get("io.koraframework.soap.client.common", "SoapResult");
    }

    default TypeName soapResultFailure() {
        return ClassName.get("io.koraframework.soap.client.common", "SoapResult", "Failure");
    }

    default TypeName soapResultSuccess() {
        return ClassName.get("io.koraframework.soap.client.common", "SoapResult", "Success");
    }
