...
public class SoapClientImplGenerator {
    ...
    private static final ClassName HTTP_CLIENT = ClassName.get("io.koraframework.http.client.common", "HttpClient");
    private static final ClassName SOAP_TELEMETRY = ClassName.get("io.koraframework.soap.client.common.telemetry", "SoapClientTelemetryFactory");
    private static final ClassName SOAP_METHOD_DESCRIPTOR = ClassName.get("io.koraframework.soap.client.common", "SoapMethodDescriptor");
    private static final ClassName SOAP_ENVELOPE = ClassName.get("io.koraframework.soap.client.common.envelope", "SoapEnvelope");
    ...
    public TypeSpec generateModule(Element element, SoapClasses soapClasses) {
        ...
        var type = TypeSpec.interfaceBuilder(moduleName)
            ...
            .addMethod(MethodSpec.methodBuilder(methodPrefix + "_SoapClientImpl")
                ...
                .addParameter(ParameterSpec.builder(ParameterizedTypeName.get(ClassName.get(Function.class), SOAP_ENVELOPE, SOAP_ENVELOPE).annotated(CommonClassNames.nullableAnnotation), "envelopeProcessor")
                    .addAnnotation(TagUtils.makeAnnotationSpec(elementType.toString()))
                    .build())
