...
public abstract class HttpClientTestBase {
    ...
    private final HttpClient baseClient = this.createClient(new $HttpClientConfig_ConfigValueMapper.HttpClientConfig_Impl(ofMillis(2000), ofMillis(500000), null, false));
    ...
    void setUp() throws Exception {
        ...
        ctx.getLogger("io.koraframework.http.client").setLevel(Level.ALL);
