...
public final class KoraVirtualThreadPerConnectionDispatchHttpHandler implements HttpHandler {
    ...
    public KoraVirtualThreadPerConnectionDispatchHttpHandler(String name, HttpHandler delegate) {
        this.name = name;
