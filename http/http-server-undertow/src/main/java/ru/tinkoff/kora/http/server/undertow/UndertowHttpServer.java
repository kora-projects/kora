...
public class UndertowHttpServer implements HttpServer, ReadinessProbe {
    ...
    private Undertow createServer() {
        ...
        return Undertow.builder()
            ...
            .setServerOption(Options.READ_TIMEOUT, config.socketReadTimeout().toMillisPart())
            .setServerOption(Options.WRITE_TIMEOUT, config.socketWriteTimeout().toMillisPart())
