...
public class HttpServerClassNames {
    ...
    public static final ClassName httpServerRequestHandlerImpl = ClassName.get("io.koraframework.http.server.common.request", "HttpServerRequestHandlerImpl");
    ...
    public static final ClassName httpServerResponseEntityMapper = ClassName.get("io.koraframework.http.server.common.response.mapper", "HttpServerResponseEntityMapper");
}
