    ...
    void testCookies() {
        compile("""
            ...
            public class Controller {
                ...
                void cookieCookie(@Cookie io.koraframework.http.common.cookie.Cookie string) {}
            
                @HttpRoute(method = GET, path = "/cookieNullableCookie")
                void cookieNullableCookie(@Cookie io.koraframework.http.common.cookie.@Nullable Cookie string) {}
            
                @HttpRoute(method = GET, path = "/cookieOptionalCookie")
                void cookieNullableCookie(@Cookie Optional<io.koraframework.http.common.cookie.Cookie> string) {}
            }
            """);
