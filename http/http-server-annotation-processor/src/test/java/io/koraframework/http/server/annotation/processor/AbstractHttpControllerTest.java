...
import io.koraframework.http.server.annotation.processor.server.HttpResponseAssert;
import io.koraframework.http.server.annotation.processor.server.TestHttpServerRequest;
...
public abstract class AbstractHttpControllerTest extends AbstractAnnotationProcessorTest {
    ...
    protected String commonImports() {
        return super.commonImports() + """
            ...
            import io.koraframework.http.server.common.interceptor.*;
