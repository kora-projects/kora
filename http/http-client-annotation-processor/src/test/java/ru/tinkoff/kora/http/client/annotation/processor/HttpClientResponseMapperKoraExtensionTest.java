...
public class HttpClientResponseMapperKoraExtensionTest extends AbstractAnnotationProcessorTest {
    @Test
    public void testExtensionAnnotatedRecord() throws Exception {
        compile(List.of(new KoraAppProcessor()), """
            ...
            public interface TestApp {
              ...
              @Root
              default String root(HttpClientResponseMapper<String> extractor) { return ""; }
            }
            """);
