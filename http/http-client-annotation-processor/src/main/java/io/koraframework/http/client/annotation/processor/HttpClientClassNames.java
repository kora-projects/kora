...
public class HttpClientClassNames {
    ...
    public static final ClassName httpClientException = ClassName.get("io.koraframework.http.client.common", "HttpClientException");
    public static final ClassName httpClientEncoderException = ClassName.get("io.koraframework.http.client.common", "HttpClientEncoderException");
    public static final ClassName httpClientResponseException = ClassName.get("io.koraframework.http.client.common", "HttpClientResponseException");
    ...
    public static final ClassName httpClientResponseEntityMapper = ClassName.get("io.koraframework.http.client.common.response", "HttpClientResponseEntityMapper");
    public static final ClassName httpClientUnknownException = ClassName.get("io.koraframework.http.client.common", "HttpClientUnknownException");
