...
public class MockGraphAddedTests {
    ...
    @Test
    void mockWithTag(@Tag(LifecycleComponent.class) @Mock @TestComponent TestComponent2 mock) {
        assertNull(mock.get());
    ...
    @Test
    void beanWithTaggedMock(@Tag(LifecycleComponent.class) @Mock @TestComponent TestComponent2 mock,
