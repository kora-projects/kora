...
public class JsonValueReadTests extends AbstractJsonAnnotationProcessorTest {
    ...
    public void jsonReaderNativeNullableIsUndefined() throws IOException {
        ...
        assertThat(o).isEqualTo(newObject("TestRecord", JsonValue.undefined()));
    }
    ...
    public void jsonReaderNativeNullableIsNullable() throws IOException {
        ...
        assertThat(o).isEqualTo(newObject("TestRecord", JsonValue.nullValue()));
    }
    ...
    public void jsonReaderNativeNullableIsPresent() throws IOException {
        ...
        assertThat(o).isEqualTo(newObject("TestRecord", JsonValue.of("test")));
    }
    ...
    public void jsonReaderUserNullableIsPresent() throws IOException {
        ...
        assertThat(o).isEqualTo(newObject("TestRecord", JsonValue.of(Timestamp.from(Instant.ofEpochMilli(1)))));
    }
