...
public @interface JsonInclude {
    ...
    enum IncludeType {
        ...
        /**
         * <b>Русский</b>: Указывает что значение должно быть всегда сериализовано (не влияет на {@link JsonNullable})
         * <hr>
         * <b>English</b>: Specifies that the value should always be serialized (doesn't affect {@link JsonNullable})
         */
        ALWAYS,

        /**
         * <b>Русский</b>: Указывает что значение должно быть сериализовано если оно не равно <i>null</i> (не влияет на {@link JsonNullable})
         * <hr>
         * <b>English</b>: Indicates that the value should be serialized if it is <i>non-null</i> (doesn't affect {@link JsonNullable})
         */
        NON_NULL,

        /**
         * <b>Русский</b>: Указывает, что значение должно быть сериализовано если оно не равно <i>null</i> и не является пустым. (применяется к {@link JsonNullable})
         * <p>
         ...
         * <hr>
         * <b>English</b>: Value that indicates that only properties with null value, or what is considered empty, are not to be included. (affects {@link JsonNullable})
         * <p>
