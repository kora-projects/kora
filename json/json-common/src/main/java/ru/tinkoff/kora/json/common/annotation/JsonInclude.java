...
public @interface JsonInclude {
    ...
    enum IncludeType {
        ...
        /**
         * <b>Русский</b>: Указывает что значение должно быть всегда сериализовано
         * <hr>
         * <b>English</b>: Specifies that the value should always be serialized
         */
        ALWAYS,

        /**
         * <b>Русский</b>: Указывает что значение должно быть сериализовано если оно не равно <i>null</i>
         * <hr>
         * <b>English</b>: Indicates that the value should be serialized if it is <i>non-null</i>
         */
        NON_NULL,

        /**
         * <b>Русский</b>: Указывает, что значение должно быть сериализовано если оно не равно <i>null</i> и не является пустым.
         * <p>
         ...
         * <hr>
         * <b>English</b>: Value that indicates that only properties with null value, or what is considered empty, are not to be included.
         * <p>
