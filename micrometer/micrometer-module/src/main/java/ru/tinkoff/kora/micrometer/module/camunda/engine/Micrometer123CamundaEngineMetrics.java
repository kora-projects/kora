...
public final class Micrometer123CamundaEngineMetrics implements CamundaEngineMetrics {
    ...
    public Micrometer123CamundaEngineMetrics(MeterRegistry meterRegistry, TelemetryConfig.MetricsConfig config) {
