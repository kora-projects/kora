...
public class Micrometer120S3ClientMetrics implements S3ClientMetrics {
    ...
    public Micrometer120S3ClientMetrics(MeterRegistry meterRegistry, TelemetryConfig.MetricsConfig config, String clientName) {
