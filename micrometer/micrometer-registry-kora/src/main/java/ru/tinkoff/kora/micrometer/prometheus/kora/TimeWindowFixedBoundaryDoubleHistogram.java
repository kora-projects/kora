...
class TimeWindowFixedBoundaryDoubleHistogram extends AbstractTimeWindowHistogram<FixedBoundaryDoubleHistogram, Void> {
    ...
    public TimeWindowFixedBoundaryDoubleHistogram(Clock clock,
    ...
    public TimeWindowFixedBoundaryDoubleHistogram(Clock clock,
        ...
        super(clock, config, FixedBoundaryDoubleHistogram.class, supportsAggregablePercentiles);
    ...
    @Override
    FixedBoundaryDoubleHistogram newBucket() {
        return new FixedBoundaryDoubleHistogram(this.buckets, isCumulativeBucketCounts);
    }

    @Override
    void recordLong(FixedBoundaryDoubleHistogram bucket, long value) {
        bucket.record(value);
    }
    ...
    @Override
    void resetBucket(FixedBoundaryDoubleHistogram bucket) {
        bucket.reset();
    }

    @Override
    Void newAccumulatedHistogram(FixedBoundaryDoubleHistogram[] ringBuffer) {
        return null;
    }
