package io.koraframework.s3.client.model.request;

import org.jspecify.annotations.Nullable;
import io.koraframework.http.common.header.MutableHttpHeaders;
import io.koraframework.s3.client.model.Range;
...
/**
 * @see <a href="GetObject">https://docs.aws.amazon.com/AmazonS3/latest/API/API_GetObject.html</a>
 */
public class GetObjectArgs {
    ...
    public GetObjectArgs setChecksumMode(@Nullable String checksumMode) {
        this.checksumMode = checksumMode;
        return this;
    }

    public GetObjectArgs setExpectedBucketOwner(@Nullable String expectedBucketOwner) {
        this.expectedBucketOwner = expectedBucketOwner;
        return this;
    }

    public GetObjectArgs setIfMatch(@Nullable String ifMatch) {
        this.ifMatch = ifMatch;
        return this;
    }

    public GetObjectArgs setIfModifiedSince(@Nullable String ifModifiedSince) {
        this.ifModifiedSince = ifModifiedSince;
        return this;
    }

    public GetObjectArgs setIfNoneMatch(@Nullable String ifNoneMatch) {
        this.ifNoneMatch = ifNoneMatch;
        return this;
    }

    public GetObjectArgs setIfUnmodifiedSince(@Nullable String ifUnmodifiedSince) {
        this.ifUnmodifiedSince = ifUnmodifiedSince;
        return this;
    }

    public GetObjectArgs setPartNumber(@Nullable Integer partNumber) {
        this.partNumber = partNumber;
        return this;
    }

    public GetObjectArgs setRange(@Nullable Range range) {
        this.range = range;
        return this;
    }

    public GetObjectArgs setRequestPayer(@Nullable String requestPayer) {
        this.requestPayer = requestPayer;
        return this;
    }

    public GetObjectArgs setResponseCacheControl(@Nullable String responseCacheControl) {
        this.responseCacheControl = responseCacheControl;
        return this;
    }

    public GetObjectArgs setResponseContentDisposition(@Nullable String responseContentDisposition) {
        this.responseContentDisposition = responseContentDisposition;
        return this;
    }

    public GetObjectArgs setResponseContentEncoding(@Nullable String responseContentEncoding) {
        this.responseContentEncoding = responseContentEncoding;
        return this;
    }

    public GetObjectArgs setResponseContentLanguage(@Nullable String responseContentLanguage) {
        this.responseContentLanguage = responseContentLanguage;
        return this;
    }

    public GetObjectArgs setResponseContentType(@Nullable String responseContentType) {
        this.responseContentType = responseContentType;
        return this;
    }

    public GetObjectArgs setResponseExpires(@Nullable String responseExpires) {
        this.responseExpires = responseExpires;
        return this;
    }

    public GetObjectArgs setSseCustomerAlgorithm(@Nullable String sseCustomerAlgorithm) {
        this.sseCustomerAlgorithm = sseCustomerAlgorithm;
        return this;
    }

    public GetObjectArgs setSseCustomerKey(@Nullable String sseCustomerKey) {
        this.sseCustomerKey = sseCustomerKey;
        return this;
    }

    public GetObjectArgs setSseCustomerKeyMD5(@Nullable String sseCustomerKeyMD5) {
        this.sseCustomerKeyMD5 = sseCustomerKeyMD5;
        return this;
    }

    public GetObjectArgs setVersionId(@Nullable String versionId) {
