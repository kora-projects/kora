...
public class DefaultCamundaRestObservation implements CamundaRestObservation {
    ...
    public DefaultCamundaRestObservation(HttpServerExchange exchange,
                                         DefaultCamundaRestTelemetry.TelemetryContext context,
                                         long requestStartTime,
                                         Span span,
                                         DefaultCamundaRestLoggerFactory.DefaultCamundaRestLogger logger,
                                         DefaultCamundaRestMetricsFactory.DefaultCamundaRestMetrics metrics) {
