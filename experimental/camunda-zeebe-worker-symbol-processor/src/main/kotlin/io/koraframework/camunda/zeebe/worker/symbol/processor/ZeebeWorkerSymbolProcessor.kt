...
class ZeebeWorkerSymbolProcessor(
    ...
    companion object {
        private val ANNOTATION_WORKER: ClassName = ClassName("io.koraframework.camunda.zeebe.worker.annotation", "JobWorker")

        private val ANNOTATION_VARIABLE: ClassName = ClassName("io.koraframework.camunda.zeebe.worker.annotation", "JobVariable")
        private val ANNOTATION_VARIABLES: ClassName = ClassName("io.koraframework.camunda.zeebe.worker.annotation", "JobVariables")

        private val CLASS_KORA_WORKER: ClassName = ClassName("io.koraframework.camunda.zeebe.worker", "KoraJobWorker")
        private val CLASS_JOB_CONTEXT: ClassName = ClassName("io.koraframework.camunda.zeebe.worker", "JobContext")
        private val CLASS_ACTIVE_CONTEXT: ClassName = ClassName("io.koraframework.camunda.zeebe.worker", "ActiveJobContext")
        private val CLASS_CLIENT: ClassName = ClassName("io.camunda.client.api.worker", "JobClient")
        private val CLASS_FINAL_COMMAND: ClassName = ClassName("io.camunda.client.api.command", "FinalCommandStep")
        private val CLASS_ACTIVE_JOB: ClassName = ClassName("io.camunda.client.api.response", "ActivatedJob")
