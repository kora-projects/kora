...
public class KoraProcessEngineConfiguration extends ProcessEngineConfigurationImpl {
    ...
    public KoraProcessEngineConfiguration(JobExecutor jobExecutor,
        ...
        setDataSource(camundaEngineDataSource.dataSource());
    ...
    protected void initTransactionContextFactory() {
        if (transactionContextFactory == null) {
            transactionContextFactory = new KoraTransactionContextFactory(camundaEngineDataSource.transactionManager());
        }
    }
    ...
    protected List<CommandInterceptor> getCommandInterceptors(boolean requiresNew) {
        return Arrays.asList(
            ...
            new KoraTransactionInterceptor(camundaEngineDataSource.transactionManager(), requiresNew),
