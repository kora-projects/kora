...
public class DefaultOperatonRestMetricsFactory {

    public static final DefaultOperatonRestMetricsFactory INSTANCE = new DefaultOperatonRestMetricsFactory();

    public DefaultOperatonRestMetrics create(DefaultOperatonRestTelemetry.TelemetryContext context) {
        return new DefaultOperatonRestMetrics(context);
    }

    public static class DefaultOperatonRestMetrics {
        ...
        public DefaultOperatonRestMetrics(DefaultOperatonRestTelemetry.TelemetryContext context) {
        ...
        protected Timer.Builder createDuration(DurationKey metricKey) {
            ...
            return Timer.builder("operaton.rest.request.duration")
        ...
        protected AtomicLong createActiveRequests(ActiveRequestsKey metricKey) {
            ...
            Gauge.builder("operaton.rest.active_requests", value, AtomicLong::get)
                .tags(Tags.of(staticTags))
