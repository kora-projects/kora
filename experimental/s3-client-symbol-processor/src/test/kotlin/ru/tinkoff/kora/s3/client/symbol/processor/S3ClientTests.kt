...
class S3ClientTests : AbstractSymbolProcessorTest() {
    ...
    fun clientListMetaWithPrefix() {
        this.compile0(
            ...
            interface Client {
                ...
                @S3.List
                fun list(prefix: String): List<S3ObjectMeta>
            }
            """.trimIndent()
        )
        compileResult.assertSuccess()
    ...
    fun clientListKeyConcat() {
        this.compile0(
            ...
            interface Client {
                ...
                @S3.List("{key1}-{key2}")
                fun list(key1: String, key2: Long): List<S3ObjectMeta>
            }
            """.trimIndent()
        )
        compileResult.assertSuccess()
