...
import io.koraframework.s3.client.kora.exception.S3ClientException;
...
public interface S3Client {
     ...
     * @throws io.koraframework.s3.client.kora.exception.S3ClientResponseException on 404 if required is true
     * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_HeadObject.html">HeadObject</a>
     */
    @Nullable
    HeadObjectResult headObject(S3Credentials credentials, String bucket, String key, @Nullable HeadObjectArgs args, boolean required) throws S3ClientException;

    /**
     * @see #headObject
     */
    default HeadObjectResult headObject(S3Credentials credentials, String bucket, String key) throws S3ClientException {
     ...
     */
    @Nullable
    default HeadObjectResult headObjectOptional(S3Credentials credentials, String bucket, String key) throws S3ClientException {
     ...
     */
    @Nullable
    GetObjectResult getObject(S3Credentials credentials, String bucket, String key, @Nullable GetObjectArgs args, boolean required);

    /**
     * @see #getObject
     */
    default GetObjectResult getObject(S3Credentials credentials, String bucket, String key, @Nullable GetObjectArgs args) {
     ...
     * @see #getObject
     */
    default GetObjectResult getObject(S3Credentials credentials, String bucket, String key) {
     ...
     * @see #getObject
     */
    default GetObjectResult getObjectOptional(S3Credentials credentials, String bucket, String key) {
     ...
     */
    void deleteObject(S3Credentials credentials, String bucket, String key, @Nullable DeleteObjectArgs args) throws S3ClientException;

    /**
     * @see #deleteObject
     */
    default void deleteObject(S3Credentials credentials, String bucket, String key) throws S3ClientException {
     ...
     */
    void deleteObjects(S3Credentials credentials, String bucket, List<String> keys) throws S3ClientException;
     ...
     */
    String putObject(S3Credentials credentials, String bucket, String key, @Nullable PutObjectArgs args, byte[] data, int off, int len) throws S3ClientException;

    /**
     * @see #putObject(S3Credentials, String, String, PutObjectArgs, byte[], int, int)
     */
    default String putObject(S3Credentials credentials, String bucket, String key, byte[] data, int off, int len) throws S3ClientException {
     ...
     * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_PutObject.html">PutObject</a>
     */
    String putObject(S3Credentials credentials, String bucket, String key, @Nullable PutObjectArgs args, ContentWriter contentWriter) throws S3ClientException;

    /**
     * @see #putObject(S3Credentials, String, String, PutObjectArgs, ContentWriter)
     */
    default String putObject(S3Credentials credentials, String bucket, String key, ContentWriter contentWriter) throws S3ClientException {
     ...
     */
    ListMultipartUploadsResult listMultipartUploads(S3Credentials credentials, String bucket, @Nullable ListMultipartUploadsArgs args) throws S3ClientException;
     ...
     */
    ListBucketResult listObjectsV2(S3Credentials credentials, String bucket, @Nullable ListObjectsArgs args);

    /**
     * @see #listObjectsV2(S3Credentials, String, ListObjectsArgs)
     */
    Iterator<ListBucketResult.ListBucketItem> listObjectsV2Iterator(S3Credentials credentials, String bucket, @Nullable ListObjectsArgs args);
     ...
     */
    String createMultipartUpload(S3Credentials credentials, String bucket, String key, @Nullable CreateMultipartUploadArgs args) throws S3ClientException;

    /**
     * @see #createMultipartUpload
     */
    default String createMultipartUpload(S3Credentials credentials, String bucket, String key) throws S3ClientException {
     ...
     */
    UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, @Nullable UploadPartArgs args, byte[] data, int off, int len) throws S3ClientException;

    /**
     * @see #uploadPart(S3Credentials, String, String, String, int, UploadPartArgs, byte[], int, int)
     */
    default UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, byte[] data, int off, int len) throws S3ClientException {
     ...
     * @see <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_UploadPart.html">UploadPart</a>
     */
    UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, @Nullable UploadPartArgs args, ContentWriter contentWriter) throws S3ClientException;

    /**
     * @see #uploadPart(S3Credentials, String, String, String, int, UploadPartArgs, ContentWriter)
     */
    default UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, ContentWriter contentWriter) throws S3ClientException {
     ...
     */
    ListPartsResult listParts(S3Credentials credentials, String bucket, String key, String uploadId, @Nullable ListPartsArgs args) throws S3ClientException;

    default ListPartsResult listParts(S3Credentials credentials, String bucket, String key, String uploadId, @Nullable Integer maxParts, @Nullable Integer partNumberMarker) throws S3ClientException {
     ...
     */
    void abortMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId, @Nullable AbortMultipartUploadArgs args) throws S3ClientException;

    /**
     * @see #abortMultipartUpload(S3Credentials, String, String, String, AbortMultipartUploadArgs)
     */
    default void abortMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId) throws S3ClientException {
     ...
     */
    String completeMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId, List<UploadedPart> parts, @Nullable CompleteMultipartUploadArgs args) throws S3ClientException;

    /**
     * @see #completeMultipartUpload
     */
    default String completeMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId, List<UploadedPart> parts) throws S3ClientException {
