...
import io.koraframework.s3.client.kora.exception.*;
import io.koraframework.s3.client.kora.impl.xml.*;
...
import io.koraframework.s3.client.kora.model.response.ListMultipartUploadsResult;
import io.koraframework.s3.client.kora.model.response.ListMultipartUploadsResult.Upload;
import io.koraframework.s3.client.kora.model.response.ListPartsResult;
...
public class KoraS3Client implements S3Client {
    ...
    public KoraS3Client(HttpClient httpClient, S3ClientConfig config, S3ClientTelemetry telemetry) {
    ...
    @Nullable
    @Override
    public HeadObjectResult headObject(S3Credentials credentials, String bucket, String key, @Nullable HeadObjectArgs args, boolean required) throws S3ClientException {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signature = signer.processRequest(this.config.region(), "s3", "HEAD", uri, queryMap, headersMap, S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
                ...
                headers.set("x-amz-content-sha256", S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
    ...
    @Nullable
    @Override
    public GetObjectResult getObject(S3Credentials credentials, String bucket, String key, @Nullable GetObjectArgs args, boolean required) {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signer = credentials instanceof S3RequestSigner s
                    ? s
                    : new S3RequestSigner(credentials.accessKey(), credentials.secretKey());
                var signature = signer.processRequest(this.config.region(), "s3", "GET", uri, queryMap, headersMap, S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
    ...
    @Override
    public void deleteObject(S3Credentials credentials, String bucket, String key, @Nullable DeleteObjectArgs args) throws S3ClientException {
        ...
        Observation.scoped(observation)
            .run(() -> {
                ...
                var signer = credentials instanceof S3RequestSigner s
                    ? s
                    : new S3RequestSigner(credentials.accessKey(), credentials.secretKey());
                var signature = signer.processRequest(this.config.region(), "s3", "DELETE", uri, queryMap, headersMap, S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
    ...
    @Override
    public void deleteObjects(S3Credentials credentials, String bucket, List<String> keys) throws S3ClientException {
    ...
    @Override
    public String putObject(S3Credentials credentials, String bucket, String key, @Nullable PutObjectArgs args, byte[] data, int off, int len) throws S3ClientException {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signer = credentials instanceof S3RequestSigner s
                    ? s
                    : new S3RequestSigner(credentials.accessKey(), credentials.secretKey());
                var signature = signer.processRequest(this.config.region(), "s3", "PUT", uri, S3RequestSigner.EMPTY_QUERY, headersMap, sha256Hex);
                ...
                try (var rs = this.httpClient.execute(request);
                    ...
                    throw KoraS3Client.parseS3Exception(rs, body);
                } catch (S3ClientException e) {
                    observation.observeError(e);
                    throw e;
                } catch (Throwable e) {
    ...
    @Override
    public String putObject(S3Credentials credentials, String bucket, String key, @Nullable PutObjectArgs args, ContentWriter contentWriter) throws S3ClientException {
        var observation = this.telemetry.observe("PutObject", bucket);
        observation.observeKey(key);
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signature = signer.processRequest(this.config.region(), "s3", "PUT", uri, S3RequestSigner.EMPTY_QUERY, headersMap, payloadSha256Hex);
    ...
    @Override
    public ListBucketResult listObjectsV2(S3Credentials credentials, String bucket, @Nullable ListObjectsArgs args) {
        return this.listInternal(credentials, bucket, args);
    }

    @Override
    public Iterator<ListBucketResult.ListBucketItem> listObjectsV2Iterator(S3Credentials credentials, String bucket, @Nullable ListObjectsArgs args) {
        if (args == null) {
    ...
    private ListBucketResult listInternal(S3Credentials credentials, String bucket, @Nullable ListObjectsArgs args) {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                try {
                    ...
                    var signature = signer.processRequest(this.config.region(), "s3", "GET", uri, queryParameters, headersMap, S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
                    headers.set("x-amz-date", signature.amzDate());
                    headers.set("authorization", signature.authorization());
                    headers.set("host", uri.getAuthority());
                    headers.set("x-amz-content-sha256", S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
                    ...
                    try (var rs = this.httpClient.execute(request);
                        ...
                        if (rs.code() == 200) {
                            try (var is = body.asInputStream()) {
                                ...
                                var listResult = io.koraframework.s3.client.kora.impl.xml.ListBucketResult.fromXml(new ByteArrayInputStream(bytes));
    ...
    @Override
    public String createMultipartUpload(S3Credentials credentials, String bucket, String key, @Nullable CreateMultipartUploadArgs args) throws S3ClientException {
    ...
    @Override
    public void abortMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId, @Nullable AbortMultipartUploadArgs args) throws S3ClientException {
    ...
    @Override
    public String completeMultipartUpload(S3Credentials credentials, String bucket, String key, String uploadId, List<UploadedPart> parts, @Nullable CompleteMultipartUploadArgs args) throws S3ClientException {
    ...
    @Override
    public ListMultipartUploadsResult listMultipartUploads(S3Credentials credentials, String bucket, @Nullable ListMultipartUploadsArgs args) throws S3ClientException {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signer = credentials instanceof S3RequestSigner s
                    ? s
                    : new S3RequestSigner(credentials.accessKey(), credentials.secretKey());
                var signature = signer.processRequest(this.config.region(), "s3", "GET", uri, queryMap, Map.of(), S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
                ...
                try (var rs = this.httpClient.execute(request)) {
                    ...
                    observation.observeAwsExtendedId(rs.headers().getFirst("x-amz-id-2"));
                    if (rs.code() == HttpURLConnection.HTTP_OK) {
                        var xml = io.koraframework.s3.client.kora.impl.xml.ListMultipartUploadsResult.fromXml(rs.body().asInputStream());
    ...
    @Override
    public UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, UploadPartArgs args, byte[] data, int off, int len) throws S3ClientException {
    ...
    @Override
    public UploadedPart uploadPart(S3Credentials credentials, String bucket, String key, String uploadId, int partNumber, UploadPartArgs args, ContentWriter contentWriter) throws S3ClientException {
        var observation = this.telemetry.observe("UploadPart", bucket);
        observation.observeKey(key);
        return Observation.scoped(observation)
            .call(() -> {
    ...
    @Override
    public ListPartsResult listParts(S3Credentials credentials, String bucket, String key, String uploadId, @Nullable ListPartsArgs args) throws S3ClientException {
        ...
        return Observation.scoped(observation)
            .call(() -> {
                ...
                var signer = credentials instanceof S3RequestSigner s
                    ? s
                    : new S3RequestSigner(credentials.accessKey(), credentials.secretKey());
                var signature = signer.processRequest(this.config.region(), "s3", "GET", uri, queryParams, headersMap, S3RequestSigner.EMPTY_PAYLOAD_SHA256_HEX);
                ...
                try (var rs = this.httpClient.execute(request);
                    ...
                    observation.observeAwsExtendedId(rs.headers().getFirst("x-amz-id-2"));
                    if (rs.code() == HttpURLConnection.HTTP_OK) {
                        var listPartsResult = io.koraframework.s3.client.kora.impl.xml.ListPartsResult.fromXml(body.asInputStream());
