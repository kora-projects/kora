...
import io.koraframework.s3.client.kora.model.request.PutObjectArgs;
...
public @interface S3 {
     ...
     * Possible arguments are path template parameters, {@link S3Credentials}, {@link S3.Bucket} annotated string and {@link GetObjectArgs}<br />
     ...
     * Possible arguments are path template parameters, {@link S3Credentials}, {@link S3.Bucket} annotated string and {@link HeadObjectArgs}<br />
     ...
     * Possible method arguments are path template parameters, {@link S3Credentials}, {@link S3.Bucket} annotated string
     ...
     * Possible arguments are path template parameters, {@link S3Credentials}, {@link S3.Bucket} annotated string, {@link PutObjectArgs}
     ...
     * Possible arguments are path template parameters, {@link S3Credentials}, {@link S3.Bucket} annotated string and {@link DeleteObjectArgs}<br />
     */
    @Target({ElementType.METHOD})
    @Retention(RetentionPolicy.CLASS)
    @interface Delete {
