...
public class DefaultS3ClientMetricsFactory {

    public static final DefaultS3ClientMetricsFactory INSTANCE = new DefaultS3ClientMetricsFactory();

    public DefaultS3ClientMetrics create(DefaultS3ClientTelemetry.TelemetryContext context) {
        return new DefaultS3ClientMetrics(context);
    }

    public static class DefaultS3ClientMetrics {
        ...
        public DefaultS3ClientMetrics(DefaultS3ClientTelemetry.TelemetryContext context) {
