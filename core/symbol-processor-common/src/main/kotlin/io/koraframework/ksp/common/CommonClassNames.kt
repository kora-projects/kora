...
object CommonClassNames {
    ...
    val aopProxy = ClassName("io.koraframework.common.annotation", "AopProxy")
    val mapping = ClassName("io.koraframework.common.annotation", "Mapping")
    val mappings = ClassName("io.koraframework.common.annotation", "Mapping", "Mappings")
    ...
    val koraSubmodule = ClassName("io.koraframework.common.annotation", "KoraSubmodule")
    val module = ClassName("io.koraframework.common.annotation", "Module")
