...
/**
 * <b>Русский</b>: Специальная аннотация, которая указывает что проаннотированная аннотация частью инфра аннотации аспекта Аспектом и должна быть прокинута на сгенерированный элемент
 * <hr>
