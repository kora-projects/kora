...
open class LogAspectTest : AbstractLogAspectTest() {

    class LogAspectChunk1Test : LogAspectTest() {
    ...
    class LogAspectChunk2Test : LogAspectTest() {
        ...
        private fun maskingRules(moduleName: String, vararg args: Any): MaskingRules<Any?> {
            ...
            val method = module.methods
                .filter { it.returnType == MaskingRules::class.java }
