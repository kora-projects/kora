...
class CassandraDatabaseTest {
    private static CassandraDatabase createCassandraDatabase(CassandraParams params) {
        ...
        return new CassandraDatabase(config, b -> b, new DefaultDataBaseTelemetryFactory(TracerProvider.noop().get(""), new CompositeMeterRegistry()), new CompositeMeterRegistry());
    }
