...
import io.koraframework.database.symbol.processor.model.QueryParameter
...
object DbUtils {
    ...
    val queryContext = ClassName("io.koraframework.database.common", "QueryContext")
    val repositoryAnnotation = ClassName("io.koraframework.database.common.annotation", "Repository")
    val columnAnnotation = ClassName("io.koraframework.database.common.annotation", "Column")
    val entityConstructorAnnotation = ClassName("io.koraframework.database.common.annotation", "EntityConstructor")
    val queryAnnotation = ClassName("io.koraframework.database.common.annotation", "Query")
    val idAnnotation = ClassName("io.koraframework.database.common.annotation", "Id")
    val tableAnnotation = ClassName("io.koraframework.database.common.annotation", "Table")
    val batchAnnotation = ClassName("io.koraframework.database.common.annotation", "Batch")
    ...
    fun KSClassDeclaration.findQueryMethods() = this.getAllFunctions()
        ...
        .filter { it.findAnnotation(queryAnnotation) != null }
