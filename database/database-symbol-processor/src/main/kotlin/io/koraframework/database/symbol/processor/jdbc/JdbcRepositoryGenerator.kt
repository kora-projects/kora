...
import io.koraframework.database.symbol.processor.DbUtils.addMapper
...
import io.koraframework.database.symbol.processor.DbUtils.resultMapperName
import io.koraframework.database.symbol.processor.DbUtils.updateCount
import io.koraframework.database.symbol.processor.Mapper
import io.koraframework.database.symbol.processor.QueryWithParameters
import io.koraframework.database.symbol.processor.RepositoryGenerator
import io.koraframework.database.symbol.processor.jdbc.StatementSetterGenerator.setStatementParams
    ...
    private fun generate(
        ...
        b.observe("_observation", returnTypeName) {
            ...
            controlFlow("try") {
                ...
                addStatement("throw io.koraframework.database.jdbc.exception.UncheckedSqlException(_e)")
