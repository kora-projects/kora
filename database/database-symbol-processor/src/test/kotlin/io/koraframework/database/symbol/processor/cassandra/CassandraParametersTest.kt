...
class CassandraParametersTest {
    ...
    class CassandraParametersChunk1Test : AbstractCassandraRepositoryTest() {
        @Test
        ...
        """.trimIndent()
            ...
            val c =
                Mockito.mockConstruction(BoundStatementBuilder::class.java) { mock: BoundStatementBuilder, context: MockedConstruction.Context? -> whenever(mock.build()).thenReturn(executor.boundStatement) }
    ...
    class CassandraParametersChunk2Test : AbstractCassandraRepositoryTest() {
