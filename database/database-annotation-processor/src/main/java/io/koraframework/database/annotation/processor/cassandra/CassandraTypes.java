...
public class CassandraTypes {
    ...
    public static final ClassName PARAMETER_COLUMN_MAPPER = ClassName.get("io.koraframework.database.cassandra.mapper.parameter", "CassandraParameterColumnMapper");
    public static final ClassName ROW_MAPPER = ClassName.get("io.koraframework.database.cassandra.mapper.result", "CassandraRowMapper");
    public static final ClassName RESULT_COLUMN_MAPPER = ClassName.get("io.koraframework.database.cassandra.mapper.result", "CassandraRowColumnMapper");
    public static final ClassName ASYNC_RESULT_SET_MAPPER = ClassName.get("io.koraframework.database.cassandra.mapper.result", "CassandraAsyncResultSetMapper");
    public static final ClassName RESULT_SET_MAPPER = ClassName.get("io.koraframework.database.cassandra.mapper.result", "CassandraResultSetMapper");
    ...
    public static final ClassName UDT_ANNOTATION = ClassName.get("io.koraframework.database.cassandra.annotation", "UDT");
    public static final ClassName CASSANDRA_ENTITY = ClassName.get("io.koraframework.database.cassandra.annotation", "EntityCassandra");
}
