...
public class DbUtils {
    public static final ClassName QUERY_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Query");
    public static final ClassName REPOSITORY_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Repository");
    public static final ClassName BATCH_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Batch");
    public static final ClassName COLUMN_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Column");
    public static final ClassName ID_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Id");
    public static final ClassName TABLE_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Table");
    public static final ClassName EMBEDDED_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "Embedded");
    public static final ClassName ENTITY_CONSTRUCTOR_ANNOTATION = ClassName.get("io.koraframework.database.common.annotation", "EntityConstructor");
    public static final ClassName QUERY_CONTEXT = ClassName.get("io.koraframework.database.common", "QueryContext");
    public static final ClassName UPDATE_COUNT = ClassName.get("io.koraframework.database.common", "UpdateCount");
