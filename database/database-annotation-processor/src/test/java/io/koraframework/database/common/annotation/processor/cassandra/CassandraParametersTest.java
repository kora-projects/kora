...
import io.koraframework.database.common.annotation.processor.cassandra.repository.AllowedParametersRepository;
...
public class CassandraParametersTest extends AbstractCassandraRepositoryTest {
    ...
    void testDtoJavaBeanParameter() {
        ...
        var repository = compileCassandra(List.of(columnMapper1, columnMapper2), """
            ...
            public interface TestRepository extends CassandraRepository {
                ...
                void test(io.koraframework.database.common.annotation.processor.entity.TestEntityJavaBean entity);
            }
            """);
    ...
    public void testDtoParameterMapping() {
        ...
        var repository = compileCassandra(List.of(mapper), """
            ...
            public interface TestRepository extends CassandraRepository {
                ...
                void test(io.koraframework.database.common.annotation.processor.entity.TestEntityRecord.TestUnknownType unknownField);
            }
            """);
    ...
    void testRecordFullParameterMapping() {
        ...
        var repository = compileCassandra(List.of(mapper), """
            ...
            public interface TestRepository extends CassandraRepository {
                ...
                void test(io.koraframework.database.common.annotation.processor.entity.TestEntityRecord rec);
            }
            """);
    ...
    public void testDtoBatch() {
        var repository = compileCassandra(List.of(
            ...
            public interface TestRepository extends CassandraRepository {
                @Query("INSERT INTO test(value1, value2) VALUES (:entity.field1, :entity.field2, :entity.field3, :entity.unknownTypeField, :entity.mappedField1, :entity.mappedField2)")
                void test(@Batch java.util.List<io.koraframework.database.common.annotation.processor.entity.TestEntityJavaBean> entity);
            }
            """);
    ...
    public void testEntityFieldMapping() {
        var repository = compileCassandra(List.of(), """
            import io.koraframework.database.cassandra.mapper.parameter.CassandraParameterColumnMapper;public final class StringToJsonbParameterMapper implements CassandraParameterColumnMapper<String> {
    ...
    public void testNativeParameterNonFinalMapper() {
        var repository = compileCassandra(List.of(newGeneratedObject("TestMapper")), """
            import io.koraframework.database.cassandra.mapper.parameter.CassandraParameterColumnMapper;public class TestMapper implements CassandraParameterColumnMapper<String> {
                @Override
                public void apply(SettableByName<?> stmt, int index, String value) {
                    stmt.set(index, java.util.Map.of("test", value), java.util.Map.class);
                }
    ...
    public void testMultipleParameterFieldsWithSameMapper() {
        var repository = compileCassandra(List.of(newGeneratedObject("TestMapper")), """
            import io.koraframework.database.cassandra.mapper.parameter.CassandraParameterColumnMapper;public class TestMapper implements CassandraParameterColumnMapper<TestRecord> {
                @Override
