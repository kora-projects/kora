...
class GraphBuilder {
    ...
    fun build(): ResolvedGraph {
        ...
        frame@ while (stack.isNotEmpty()) {
            ...
            dependency@ for (currentDependency in frame.currentDependency until dependenciesToFind.size) {
                ...
                val templates =
                    findDependencyDeclarationsFromTemplate(ctx, declaration, templateDeclarations, dependencyClaim)
    ...
    private fun checkCycle(declaration: ComponentDeclaration): Boolean {
        ...
        for (frame in stack) {
            ...
            var proxyComponentDeclarations = findDependencyDeclarationsFromTemplate(
