...
import io.koraframework.cache.symbol.processor.testcache.DummyCache12
import io.koraframework.cache.symbol.processor.testdata.CacheableSyncOneMany
    ...
    private fun getService(): CacheableSyncOneMany {
        ...
        return try {
            val classLoader = symbolProcess(
                ...
                listOf(DummyCache11::class, DummyCache12::class, CacheableSyncOneMany::class),
            )
