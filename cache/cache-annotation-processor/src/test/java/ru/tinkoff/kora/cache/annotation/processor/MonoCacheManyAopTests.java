...
class MonoCacheManyAopTests implements CaffeineCacheModule, RedisCacheModule {
    ...
    private CacheableMonoMany getService() {
        ...
        try {
            var classLoader = TestUtils.annotationProcess(List.of(DummyCache21.class, DummyCache22.class, CacheableMonoMany.class),
