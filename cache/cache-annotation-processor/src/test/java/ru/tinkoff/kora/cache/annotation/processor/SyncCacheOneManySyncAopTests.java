...
import ru.tinkoff.kora.cache.annotation.processor.testdata.sync.CacheableSyncOneManySync;
...
class SyncCacheOneManySyncAopTests implements CaffeineCacheModule, RedisCacheModule {
    ...
    private static final String CACHED_SERVICE = "ru.tinkoff.kora.cache.annotation.processor.testdata.sync.$CacheableSyncOneManySync__AopProxy";
