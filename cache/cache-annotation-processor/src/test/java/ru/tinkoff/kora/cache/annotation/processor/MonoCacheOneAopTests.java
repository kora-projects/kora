...
class MonoCacheOneAopTests implements CaffeineCacheModule {
    ...
    private CacheableMonoOne getService() {
        ...
        try {
            var classLoader = TestUtils.annotationProcess(List.of(DummyCache11.class, CacheableMonoOne.class),
