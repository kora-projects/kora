...
import io.koraframework.cache.annotation.processor.testdata.sync.CacheableSyncOneMany;
...
class SyncCacheOneManyAopTests implements CaffeineCacheModule, RedisCacheModule {
    ...
    private CacheableSyncOneMany getService() {
        ...
        try (
            var holder = TestUtils.annotationProcess(List.of(DummyCache11.class, DummyCache12.class, CacheableSyncOneMany.class),
            ...
            cache2 = (DummyCache12) cacheConstructor2.newInstance(CacheRunner.getRedisConfig(),
                CacheRunner.lettuceClient(cache), defaultRedisCacheTelemetryFactory(null, null, null, null),
