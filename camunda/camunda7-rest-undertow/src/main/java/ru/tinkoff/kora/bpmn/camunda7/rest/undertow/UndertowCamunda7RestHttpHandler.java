...
final class UndertowCamunda7RestHttpHandler implements HttpHandler, Lifecycle, Wrapped<HttpHandler> {
    ...
    UndertowCamunda7RestHttpHandler(Application application, Camunda7RestConfig camundaRestConfig) {
