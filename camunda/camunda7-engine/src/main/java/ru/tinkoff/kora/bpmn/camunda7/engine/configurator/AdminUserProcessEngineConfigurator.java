...
public final class AdminUserProcessEngineConfigurator implements ProcessEngineConfigurator {
    ...
    private final Camunda7EngineConfig.AdminConfig adminConfig;
    private final JdbcConnectionFactory connectionFactory;

    public AdminUserProcessEngineConfigurator(Camunda7EngineConfig camundaEngineConfig, JdbcConnectionFactory connectionFactory) {
