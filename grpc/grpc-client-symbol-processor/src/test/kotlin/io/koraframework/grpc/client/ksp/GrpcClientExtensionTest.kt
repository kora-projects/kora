...
class GrpcClientExtensionTest : AbstractSymbolProcessorTest() {
    protected fun compile(@Language("kotlin") vararg sources: String) {
        ...
        patchedSources[sources.size] = """
            ...
            interface ConfigModule : io.koraframework.grpc.client.GrpcClientModule, io.koraframework.config.common.mapper.ConfigValueMapperModule {
    ...
    fun testBlockingStub() {
        compile(
            ...
            interface TestApp {
              @Root
              fun test(stub: io.koraframework.grpc.server.events.EventsGrpc.EventsBlockingStub): String {
                return ""
              }
            }
    ...
    fun testFutureStub() {
        compile(
            ...
            interface TestApp {
              @Root
              fun test(stub: io.koraframework.grpc.server.events.EventsGrpc.EventsFutureStub): String {
                return ""
              }
            }
    ...
    fun testCoroutineStubStub() {
        compile(
            ...
            """.trimIndent(),
            """
                import io.koraframework.grpc.server.events.*
                ...
                import io.koraframework.grpc.server.events.EventsGrpc.getServiceDescriptor
