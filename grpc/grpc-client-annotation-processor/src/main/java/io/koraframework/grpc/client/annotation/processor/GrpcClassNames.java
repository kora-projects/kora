...
public class GrpcClassNames {
    ...
    public static final ClassName managedChannelLifecycle = ClassName.get("io.koraframework.grpc.client.channel", "ManagedChannelLifecycle");
    public static final ClassName grpcClientConfig = ClassName.get("io.koraframework.grpc.client", "GrpcClientConfig");
}
