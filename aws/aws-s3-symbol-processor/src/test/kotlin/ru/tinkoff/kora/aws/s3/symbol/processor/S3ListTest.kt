...
import ru.tinkoff.kora.aws.s3.model.response.ListBucketResult.ListBucketItem
...
class S3ListTest : AbstractS3ClientTest() {
    ...
    fun testList() {
        ...
        val list = listOf(ListBucketItem("test", "test1", "etag", null, null, null, 1L, null, null))
    ...
    fun testListReturnsListBucketResultWithConstPrefix() {
        ...
        val items = listOf(ListBucketItem("b", "k1", "etag", null, null, null, 10L, null, null))
    ...
    fun testIteratorStringLazyPages() {
        ...
        val item1 = ListBucketItem("b", "k1", "etag", null, null, null, 1L, null, null)
        val item2 = ListBucketItem("b", "k2", "etag", null, null, null, 2L, null, null)
    ...
    fun testIteratorItemsLazyPages() {
        ...
        val args = ListObjectsArgs()
        val it = client.invoke<MutableIterator<ListBucketItem?>?>("iteratorItems", creds, "bucket", args)

        assertThat<ListBucketItem?>(it!!.next()).isSameAs(item1)
        assertThat<ListBucketItem?>(it.next()).isSameAs(item2)
    ...
    fun testListItemsMappingWithTemplatePrefix() {
        ...
        val items = listOf(ListBucketItem("b", "item-key", "etag", null, null, null, 5L, null, null))
        val res = ListBucketResult(null, 1, null, items)
        ...
        val result = client.invoke<MutableList<ListBucketItem?>?>("items", creds, "bucket", "x")
        assertThat<ListBucketItem?>(result).hasSize(1)
