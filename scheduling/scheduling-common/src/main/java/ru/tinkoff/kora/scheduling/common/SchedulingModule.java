...
import ru.tinkoff.kora.scheduling.common.telemetry.*;
...
public interface SchedulingModule {
    ...
    @DefaultComponent
    default SchedulingLoggerFactory defaultSchedulingLoggerFactory() {
        return new Slf4jSchedulingLoggerFactory();
    }
