...
object CommonClassNames {
    ...
    val aopAnnotationUtil = ClassName("io.koraframework.common", "AopUtil")
    ...
    val namingStrategy = ClassName("io.koraframework.common", "NamingStrategy")
    val tag = ClassName("io.koraframework.common", "Tag")
    val tagAny = ClassName("io.koraframework.common", "Tag", "Any")
    ...
    val koraApp = ClassName("io.koraframework.common", "KoraApp")
    val koraSubmodule = ClassName("io.koraframework.common", "KoraSubmodule")
    val module = ClassName("io.koraframework.common", "Module")
    val component = ClassName("io.koraframework.common", "Component")
    val defaultComponent = ClassName("io.koraframework.common", "DefaultComponent")
    ...
    val nodeWithMapper = ClassName("io.koraframework.application.graph", "NodeWithMapper")
    ...
    val refreshListener = ClassName("io.koraframework.application.graph", "RefreshListener")
    ...
    val telemetryConfig = ClassName("io.koraframework.telemetry.common", "TelemetryConfig")
