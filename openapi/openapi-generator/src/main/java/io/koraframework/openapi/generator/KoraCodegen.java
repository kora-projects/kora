...
//                modelName);
        ...
        if (ModelUtils.isMapSchema(target)) {
            ...
            if (params.codegenMode.isKotlin() && property.isNullable) {
                if (property.required) {
                    return getSchemaType(target) + "<String, io.koraframework.json.common.JsonNullable<" + getTypeDeclaration(inner) + ">>";
                } else {
                    return getSchemaType(target) + "<String, io.koraframework.json.common.JsonNullable<" + getTypeDeclaration(inner) + ">>?";
                }
    ...
    public void preprocessOpenAPI(OpenAPI openAPI) {
        ...
        security.fromOpenapi(openAPI, params.useSecurityDeclarationOrder, params.securityRequirementMode);
...
//        }
    ...
    protected ImmutableMap.Builder<String, Mustache.Lambda> addMustacheLambdas() {
        return super.addMustacheLambdas()
            ...
            .put("kotlinApiResponses", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ApiResponseGenerator()))
            .put("kotlinClientApi", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ClientApiGenerator()))
            ...
            .put("kotlinServerApiModule", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ServerApiModuleGenerator()))
            .put("kotlinServerRequestMappers", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ServerRequestMappersGenerator()))
            .put("kotlinServerResponseMappers", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ServerResponseMappersGenerator()))
            .put("kotlinServerSecuritySchema", kotlinGen(new io.koraframework.openapi.generator.kotlingen.ServerSecuritySchemaGenerator()))
            ;
    }
