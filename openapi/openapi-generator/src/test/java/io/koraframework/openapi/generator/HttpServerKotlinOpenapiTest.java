...
class HttpServerKotlinOpenapiTest {

    static class HttpServerKotlinOpenapiBaseChunk1Test extends BaseKotlinOpenapiTest {
        public static SwaggerParams[] source() {return generateParamsChunk(4, 0);}

        @ParameterizedTest
        @MethodSource("source")
        void test(SwaggerParams params) throws Exception {
            process(params.name(), "kotlin-server", params.spec(), params.options());
        }
    }

    static class HttpServerKotlinOpenapiBaseChunk2Test extends BaseKotlinOpenapiTest {
    ...
    static class HttpServerKotlinOpenapiBaseChunk3Test extends BaseKotlinOpenapiTest {
    ...
    static class HttpServerKotlinOpenapiBaseChunk4Test extends BaseKotlinOpenapiTest {
    ...
    static class HttpServerKotlinOpenapiChunk1Test extends BaseKotlinOpenapiTest {
    ...
    static class HttpServerKotlinOpenapiChunk2Test extends BaseKotlinOpenapiTest {
