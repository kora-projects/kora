...
open class KafkaPublisherTest : AbstractSymbolProcessorTest() {
    ...
    class KafkaPublisherChunk1Test : KafkaPublisherTest() {
    ...
    class KafkaPublisherChunk2Test : KafkaPublisherTest() {
