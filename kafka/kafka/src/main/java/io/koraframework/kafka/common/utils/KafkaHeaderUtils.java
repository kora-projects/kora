...
public final class KafkaHeaderUtils {
    ...
    public static String toMaskedString(Set<String> maskedHeaders, KafkaArgMaskingStrategy maskingStrategy, Headers headers) {
        ...
        for (var header : headers) {
            ...
            if (maskedHeaders.contains(header.key().toLowerCase(Locale.ROOT))) {
                result.append(maskingStrategy.mask(header.key(), value));
            } else if (value != null) {
